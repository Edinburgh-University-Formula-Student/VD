...
Bell_CrankL_Left_Length_BACK = 0.075; %TO PUSHROD
Bell_CrankL_Right_Length_BACK = 0.055; %TO SHOCK
...
Shock_Pickup_Height_BACK = 0.03264; %Bell_CrankL_Right_Length_BACK; %m
Bell_CrankL_Pickup_Height_BACK = -0.20; %Bell_CrankL_Right_Length_BACK+0.03; %-0.2+0.05; %m
...
% for j=Number_Of_Iterations:Number_Of_Iterations
    for i=Number_Of_Iterations:Number_Of_Iterations
        ...
        ShockL_Pickup_ORIGIN_BACK = [-1290 20 -264.68]./1000;
        CrankL_Pickup_ORIGIN_BACK = [-1290 261.775+20 -284.68]./1000;
...
% Bell_CrankL_Pickup_Height_BACK = -0.15; %Bell_CrankL_Right_Length_BACK+0.03; %-0.2+0.05; %m
        ...
        PushRod_Length_BACK = sqrt( (PushRod_Delta_X_BACK)^2 + (PushRod_Delta_Y_BACK)^2 + (PushRod_Delta_Z_BACK)^2 ) -0.01; %+ 0.04;
        PushRod_x_sec_BACK = [0 -PushRod_Length_BACK/2; 0.75/100 -PushRod_Length_BACK/2; 0.75/100 PushRod_Length_BACK/2; 0 PushRod_Length_BACK/2];
...
[-1290 20 -264.68]./1000;
[1378.62-(1675.93-1571) 279-279 524.32-1000*chassis_height/2]

ShockL_Pickup_ORIGIN_BACK*1000 + Chassis_Rear_SUS_Center_to_SW_Origin;
CrankL_Pickup_ORIGIN_BACK*1000 + Chassis_Rear_SUS_Center_to_SW_Origin;
